...
```typescript
import { ListCChainAtomicTransactionsResponseTransactions } from "@avalabs/avalanche-sdk/models/components";

let value: ListCChainAtomicTransactionsResponseTransactions = {
