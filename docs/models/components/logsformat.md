...
let value: LogsFormat = {
  orgId: "<id>",
  logId: "<id>",
  eventTimestamp: 1478.01,
  apiKeyId: "<id>",
  apiKeyAlias: "<value>",
  hostRegion: "<value>",
  requestType: "data",
  requestPath: "<value>",
  apiCreditsConsumed: 8735.57,
  requestDurationMsecs: 4918.92,
  responseCode: 8989.61,
  metadata: {
    ipAddress: "136.83.81.114",
    host: "irresponsible-formation.org",
    userAgent: "<value>",
  },
};
```
