...
let value: LogsFormat = {
  orgId: "<id>",
  logId: "<id>",
  eventTimestamp: 7104.56,
  apiKeyId: "<id>",
  apiKeyAlias: "<value>",
  hostRegion: "<value>",
  requestType: "data",
  requestPath: "<value>",
  apiCreditsConsumed: 4835.18,
  requestDurationMsecs: 1403.16,
  responseCode: 3589.95,
  metadata: {
    ipAddress: "e67d:f35d:ad4b:7699:7eaa:6cbb:7aa3:d9a9",
    host: "odd-omelet.info",
    userAgent: "<value>",
  },
};
```
