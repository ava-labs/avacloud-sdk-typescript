...
async function run() {
  const result = await avaCloudSDK.glacier.evm.contracts.getContractMetadata({
...
import { glacierEvmContractsGetContractMetadata } from "@avalabs/avacloud-sdk/funcs/glacierEvmContractsGetContractMetadata.js";
...
async function run() {
  const res = await glacierEvmContractsGetContractMetadata(avaCloudSDK, {
    address: "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E",
  });
