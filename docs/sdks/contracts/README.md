...
async function run() {
  const result = await avaCloudSDK.data.evm.contracts.getDeploymentTransaction({
    chainId: "43114",
...
import { dataEvmContractsGetDeploymentTransaction } from "@avalabs/avacloud-sdk/funcs/dataEvmContractsGetDeploymentTransaction.js";
...
async function run() {
  const res = await dataEvmContractsGetDeploymentTransaction(avaCloudSDK, {
    chainId: "43114",
    address: "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E",
    currency: "usd",
  });
...
async function run() {
  const result = await avaCloudSDK.data.evm.contracts.getMetadata({
    chainId: "43114",
    address: "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E",
  });
...
```typescript
import { AvaCloudSDKCore } from "@avalabs/avacloud-sdk/core.js";
import { dataEvmContractsGetMetadata } from "@avalabs/avacloud-sdk/funcs/dataEvmContractsGetMetadata.js";
...
async function run() {
  const res = await dataEvmContractsGetMetadata(avaCloudSDK, {
    chainId: "43114",
    address: "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E",
  });
...
async function run() {
  const result = await avaCloudSDK.data.evm.contracts.listTransfers({
    startBlock: 6479329,
    endBlock: 6479330,
    chainId: "43114",
...
```typescript
import { AvaCloudSDKCore } from "@avalabs/avacloud-sdk/core.js";
import { dataEvmContractsListTransfers } from "@avalabs/avacloud-sdk/funcs/dataEvmContractsListTransfers.js";
...
async function run() {
  const res = await dataEvmContractsListTransfers(avaCloudSDK, {
    startBlock: 6479329,
    endBlock: 6479330,
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
