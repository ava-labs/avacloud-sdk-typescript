...
* [compositeQueryV1](#compositequeryv1) - Composite query
* [compositeQueryV2](#compositequeryv2) - Composite query
...
async function run() {
  const result = await avalancheSDK.metrics.lookingGlass.getNftHoldersByContractAddress({
    pageSize: 10,
...
import { metricsLookingGlassGetNftHoldersByContractAddress } from "@avalabs/avalanche-sdk/funcs/metricsLookingGlassGetNftHoldersByContractAddress.js";
...
async function run() {
  const res = await metricsLookingGlassGetNftHoldersByContractAddress(avalancheSDK, {
    pageSize: 10,
    address: "0x7a420AEFF902AAa2c85a190D7B91Ce8BEFffFE14",
  });
...
async function run() {
  const result = await avalancheSDK.metrics.lookingGlass.getAddressesByBalanceOverTime({
    threshold: "1000000",
...
```typescript
import { AvalancheSDKCore } from "@avalabs/avalanche-sdk/core.js";
import { metricsLookingGlassGetAddressesByBalanceOverTime } from "@avalabs/avalanche-sdk/funcs/metricsLookingGlassGetAddressesByBalanceOverTime.js";
...
async function run() {
  const res = await metricsLookingGlassGetAddressesByBalanceOverTime(avalancheSDK, {
    threshold: "1000000",
    startTimestamp: 1689541049,
    endTimestamp: 1689800249,
    pageSize: 10,
...
async function run() {
  const result = await avalancheSDK.metrics.lookingGlass.getAddressesByBtcbBridged({
    threshold: "1000000",
    pageSize: 10,
  });
...
```typescript
import { AvalancheSDKCore } from "@avalabs/avalanche-sdk/core.js";
import { metricsLookingGlassGetAddressesByBtcbBridged } from "@avalabs/avalanche-sdk/funcs/metricsLookingGlassGetAddressesByBtcbBridged.js";
...
async function run() {
  const res = await metricsLookingGlassGetAddressesByBtcbBridged(avalancheSDK, {
    threshold: "1000000",
    pageSize: 10,
  });
...
async function run() {
  const result = await avalancheSDK.metrics.lookingGlass.getValidatorsByDateRange({
    startTimestamp: 1689541049,
    endTimestamp: 1689800249,
    pageSize: 10,
...
```typescript
import { AvalancheSDKCore } from "@avalabs/avalanche-sdk/core.js";
import { metricsLookingGlassGetValidatorsByDateRange } from "@avalabs/avalanche-sdk/funcs/metricsLookingGlassGetValidatorsByDateRange.js";
...
async function run() {
  const res = await metricsLookingGlassGetValidatorsByDateRange(avalancheSDK, {
    startTimestamp: 1689541049,
    endTimestamp: 1689800249,
    pageSize: 10,
    subnetId: "11111111111111111111111111111111LpoYY",
...
async function run() {
  const result = await avalancheSDK.metrics.lookingGlass.compositeQueryV1({
    queries: [
...
```typescript
import { AvalancheSDKCore } from "@avalabs/avalanche-sdk/core.js";
import { metricsLookingGlassCompositeQueryV1 } from "@avalabs/avalanche-sdk/funcs/metricsLookingGlassCompositeQueryV1.js";
...
async function run() {
  const res = await metricsLookingGlassCompositeQueryV1(avalancheSDK, {
    queries: [
...
async function run() {
  const result = await avalancheSDK.metrics.lookingGlass.compositeQueryV2({
    queries: [
...
```typescript
import { AvalancheSDKCore } from "@avalabs/avalanche-sdk/core.js";
import { metricsLookingGlassCompositeQueryV2 } from "@avalabs/avalanche-sdk/funcs/metricsLookingGlassCompositeQueryV2.js";
...
async function run() {
  const res = await metricsLookingGlassCompositeQueryV2(avalancheSDK, {
    queries: [
