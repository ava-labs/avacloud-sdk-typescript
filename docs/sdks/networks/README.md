...
async function run() {
  const result = await avaCloudSDK.metrics.networks.getStakingMetrics({
...
import { metricsNetworksGetStakingMetrics } from "@avalabs/avacloud-sdk/funcs/metricsNetworksGetStakingMetrics.js";
...
async function run() {
  const res = await metricsNetworksGetStakingMetrics(avaCloudSDK, {
    metric: "validatorCount",
    startTimestamp: 1689541049,
    endTimestamp: 1689800249,
    network: "mainnet",
