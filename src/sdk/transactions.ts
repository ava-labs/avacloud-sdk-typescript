...
export class Transactions extends ClientSDK {
    ...
    async getTxByHash(
        ...
        return unwrapAsync(dataPrimaryNetworkTransactionsGetTxByHash(this, request, options));
    }
    ...
    async listAssetTransactions(
        ...
        return unwrapResultIterator(
            dataPrimaryNetworkTransactionsListAssetTransactions(this, request, options)
        );
    }
}
