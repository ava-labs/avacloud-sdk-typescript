...
import { metricsLookingGlassCompositeQueryV1 } from "../funcs/metricsLookingGlassCompositeQueryV1.js";
import { metricsLookingGlassCompositeQueryV2 } from "../funcs/metricsLookingGlassCompositeQueryV2.js";
...
export class LookingGlass extends ClientSDK {
     ...
     */
    async compositeQueryV1(
        request: components.CompositeQueryRequestDto,
        options?: RequestOptions & { serverURL?: string }
    ): Promise<components.CompositeQueryResponse> {
        return unwrapAsync(metricsLookingGlassCompositeQueryV1(this, request, options));
    }
     ...
     * Composite query to get list of addresses from multiple subqueries.
     */
    async compositeQueryV2(
        request: components.CompositeQueryRequestDto,
        options?: RequestOptions & { serverURL?: string }
    ): Promise<components.CompositeQueryResponse> {
        return unwrapAsync(metricsLookingGlassCompositeQueryV2(this, request, options));
    }
}
