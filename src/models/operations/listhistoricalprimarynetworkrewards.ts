...
/** @internal */
export const ListHistoricalPrimaryNetworkRewardsGlobals$inboundSchema: z.ZodType<
...
/** @internal */
export const ListHistoricalPrimaryNetworkRewardsGlobals$outboundSchema: z.ZodType<
...
export namespace ListHistoricalPrimaryNetworkRewardsGlobals$ {
    ...
    export const inboundSchema = ListHistoricalPrimaryNetworkRewardsGlobals$inboundSchema;
    /** @deprecated use `ListHistoricalPrimaryNetworkRewardsGlobals$outboundSchema` instead. */
    export const outboundSchema = ListHistoricalPrimaryNetworkRewardsGlobals$outboundSchema;
...
/** @internal */
export const ListHistoricalPrimaryNetworkRewardsResponse$inboundSchema: z.ZodType<
...
/** @internal */
export const ListHistoricalPrimaryNetworkRewardsResponse$outboundSchema: z.ZodType<
...
export namespace ListHistoricalPrimaryNetworkRewardsResponse$ {
    ...
    export const inboundSchema = ListHistoricalPrimaryNetworkRewardsResponse$inboundSchema;
    /** @deprecated use `ListHistoricalPrimaryNetworkRewardsResponse$outboundSchema` instead. */
    export const outboundSchema = ListHistoricalPrimaryNetworkRewardsResponse$outboundSchema;
