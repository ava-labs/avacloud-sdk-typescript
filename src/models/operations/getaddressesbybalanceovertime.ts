...
export const GetAddressesByBalanceOverTimeServerList = ["http://localhost:3001"] as const;
...
export namespace GetAddressesByBalanceOverTimeGlobals$ {
    ...
    export const inboundSchema = GetAddressesByBalanceOverTimeGlobals$inboundSchema;
    /** @deprecated use `GetAddressesByBalanceOverTimeGlobals$outboundSchema` instead. */
    export const outboundSchema = GetAddressesByBalanceOverTimeGlobals$outboundSchema;
...
export namespace GetAddressesByBalanceOverTimeRequest$ {
    ...
    export const inboundSchema = GetAddressesByBalanceOverTimeRequest$inboundSchema;
    /** @deprecated use `GetAddressesByBalanceOverTimeRequest$outboundSchema` instead. */
    export const outboundSchema = GetAddressesByBalanceOverTimeRequest$outboundSchema;
...
export namespace GetAddressesByBalanceOverTimeResponse$ {
    ...
    export const inboundSchema = GetAddressesByBalanceOverTimeResponse$inboundSchema;
    /** @deprecated use `GetAddressesByBalanceOverTimeResponse$outboundSchema` instead. */
    export const outboundSchema = GetAddressesByBalanceOverTimeResponse$outboundSchema;
