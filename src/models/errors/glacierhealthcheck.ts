 ...
 */
export type GlacierHealthCheckResponseBodyData = {
    status?: string | undefined;
 ...
 * The Health Check is not successful
 */
export class GlacierHealthCheckResponseBody extends Error {
    status?: string | undefined;
    info?: { [k: string]: Info } | null | undefined;
    error?: { [k: string]: ErrorT } | null | undefined;
    details?: { [k: string]: Details } | undefined;
    ...
    data$: GlacierHealthCheckResponseBodyData;

    constructor(err: GlacierHealthCheckResponseBodyData) {
        const message =
        ...
        this.name = "GlacierHealthCheckResponseBody";
    }
}
...
> = z
    ...
    .transform((v) => {
        return new GlacierHealthCheckResponseBody(v);
    });
...
export const GlacierHealthCheckResponseBody$outboundSchema: z.ZodType<
    ...
    GlacierHealthCheckResponseBody
> = z
    .instanceof(GlacierHealthCheckResponseBody)
    .transform((v) => v.data$)
    .pipe(
        z.object({
            status: z.string().optional(),
