 ...
 */
export type MetricsHealthCheckResponseBodyData = {
  status?: string | undefined;
 ...
 * The Health Check is not successful
 */
export class MetricsHealthCheckResponseBody extends Error {
  status?: string | undefined;
  info?: { [k: string]: Info } | null | undefined;
  error?: { [k: string]: ErrorT } | null | undefined;
  details?: { [k: string]: Details } | undefined;
  ...
  data$: MetricsHealthCheckResponseBodyData;

  constructor(err: MetricsHealthCheckResponseBodyData) {
    ...
    this.name = "MetricsHealthCheckResponseBody";
  }
}
...
> = z.object({
  ...
  .transform((v) => {
    return new MetricsHealthCheckResponseBody(v);
  });
...
export const MetricsHealthCheckResponseBody$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  MetricsHealthCheckResponseBody
> = z.instanceof(MetricsHealthCheckResponseBody)
  .transform(v => v.data$)
  .pipe(z.object({
    status: z.string().optional(),
