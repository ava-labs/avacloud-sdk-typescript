...
/** @internal */
export const Network$inboundSchema: z.ZodNativeEnum<typeof Network> = z.nativeEnum(Network);

/** @internal */
export const Network$outboundSchema: z.ZodNativeEnum<typeof Network> = Network$inboundSchema;
