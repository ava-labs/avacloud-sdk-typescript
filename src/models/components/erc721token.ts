...
/** @internal */
export const ErcType$inboundSchema: z.ZodNativeEnum<typeof ErcType> = z
  .nativeEnum(ErcType);

/** @internal */
export const ErcType$outboundSchema: z.ZodNativeEnum<typeof ErcType> =
  ErcType$inboundSchema;
