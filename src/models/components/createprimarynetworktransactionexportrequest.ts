...
/** @internal */
export const CreatePrimaryNetworkTransactionExportRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const CreatePrimaryNetworkTransactionExportRequest$outboundSchema: z.ZodType<
...
export namespace CreatePrimaryNetworkTransactionExportRequest$ {
    ...
    export const inboundSchema = CreatePrimaryNetworkTransactionExportRequest$inboundSchema;
    /** @deprecated use `CreatePrimaryNetworkTransactionExportRequest$outboundSchema` instead. */
    export const outboundSchema = CreatePrimaryNetworkTransactionExportRequest$outboundSchema;
