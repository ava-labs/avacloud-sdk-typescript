...
> = z.object({
    ...
    internalTransactions: z.array(InternalTransactionDetails$inboundSchema).optional(),
});
...
> = z.object({
    ...
    internalTransactions: z.array(InternalTransactionDetails$outboundSchema).optional(),
});
