...
/** @internal */
export const DelegationStatus$inboundSchema: z.ZodNativeEnum<typeof DelegationStatus> =
    z.nativeEnum(DelegationStatus);

/** @internal */
export const DelegationStatus$outboundSchema: z.ZodNativeEnum<typeof DelegationStatus> =
