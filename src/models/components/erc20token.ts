...
/** @internal */
export const Erc20TokenErcType$inboundSchema: z.ZodNativeEnum<typeof Erc20TokenErcType> =
    z.nativeEnum(Erc20TokenErcType);

/** @internal */
export const Erc20TokenErcType$outboundSchema: z.ZodNativeEnum<typeof Erc20TokenErcType> =
...
/** @internal */
export const Erc20Token$inboundSchema: z.ZodType<Erc20Token, z.ZodTypeDef, unknown> = z.object({
    address: z.string(),
    name: z.string(),
    symbol: z.string(),
    decimals: z.number(),
...
/** @internal */
export const Erc20Token$outboundSchema: z.ZodType<Erc20Token$Outbound, z.ZodTypeDef, Erc20Token> =
    z.object({
        address: z.string(),
        name: z.string(),
        symbol: z.string(),
