...
/** @internal */
export const IncludeChains$inboundSchema: z.ZodNativeEnum<typeof IncludeChains> =
    z.nativeEnum(IncludeChains);

/** @internal */
export const IncludeChains$outboundSchema: z.ZodNativeEnum<typeof IncludeChains> =
