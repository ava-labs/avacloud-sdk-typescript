...
/** @internal */
export const PrimaryNetworkTxType$inboundSchema: z.ZodNativeEnum<typeof PrimaryNetworkTxType> =
    z.nativeEnum(PrimaryNetworkTxType);

/** @internal */
export const PrimaryNetworkTxType$outboundSchema: z.ZodNativeEnum<typeof PrimaryNetworkTxType> =
