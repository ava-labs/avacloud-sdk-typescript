...
/** @internal */
export const ChainInfo$inboundSchema: z.ZodType<ChainInfo, z.ZodTypeDef, unknown> = z.object({
    chainId: z.string(),
...
/** @internal */
export const ChainInfo$outboundSchema: z.ZodType<ChainInfo$Outbound, z.ZodTypeDef, ChainInfo> =
    z.object({
        chainId: z.string(),
