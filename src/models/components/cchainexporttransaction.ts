...
/** @internal */
export const TxType$inboundSchema: z.ZodNativeEnum<typeof TxType> = z.nativeEnum(TxType);

/** @internal */
export const TxType$outboundSchema: z.ZodNativeEnum<typeof TxType> = TxType$inboundSchema;
