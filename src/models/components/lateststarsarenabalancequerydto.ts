...
/** @internal */
export const LatestStarsArenaBalanceQueryDtoType$outboundSchema: z.ZodNativeEnum<
    typeof LatestStarsArenaBalanceQueryDtoType
...
export namespace LatestStarsArenaBalanceQueryDtoType$ {
    ...
    export const inboundSchema = LatestStarsArenaBalanceQueryDtoType$inboundSchema;
    /** @deprecated use `LatestStarsArenaBalanceQueryDtoType$outboundSchema` instead. */
    export const outboundSchema = LatestStarsArenaBalanceQueryDtoType$outboundSchema;
}
