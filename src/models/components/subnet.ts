...
/** @internal */
export const Subnet$inboundSchema: z.ZodType<Subnet, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Subnet$outboundSchema: z.ZodType<Subnet$Outbound, z.ZodTypeDef, Subnet> = z.object({
    createBlockTimestamp: z.number(),
    createBlockIndex: z.string(),
    subnetId: z.string(),
    ownerAddresses: z.array(z.string()),
