...
/** @internal */
export const EvmBlock$inboundSchema: z.ZodType<EvmBlock, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const EvmBlock$outboundSchema: z.ZodType<EvmBlock$Outbound, z.ZodTypeDef, EvmBlock> =
    z.object({
        blockNumber: z.string(),
        blockTimestamp: z.number(),
        blockHash: z.string(),
