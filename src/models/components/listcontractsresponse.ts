...
/** @internal */
export const Contracts$inboundSchema: z.ZodType<Contracts, z.ZodTypeDef, unknown> = z.union([
...
/** @internal */
export const Contracts$outboundSchema: z.ZodType<Contracts$Outbound, z.ZodTypeDef, Contracts> =
    z.union([
...
> = z.object({
    ...
    contracts: z.array(
        z.union([
            UnknownContract$inboundSchema.and(
                z
                    .object({ ercType: z.literal("UNKNOWN") })
                    .transform((v) => ({ ercType: v.ercType }))
            ),
            Erc721Contract$inboundSchema.and(
                z
                    .object({ ercType: z.literal("ERC-721") })
                    .transform((v) => ({ ercType: v.ercType }))
            ),
            Erc1155Contract$inboundSchema.and(
                z
                    .object({ ercType: z.literal("ERC-1155") })
                    .transform((v) => ({ ercType: v.ercType }))
            ),
            Erc20Contract$inboundSchema.and(
                z
                    .object({ ercType: z.literal("ERC-20") })
                    .transform((v) => ({ ercType: v.ercType }))
            ),
        ])
    ),
