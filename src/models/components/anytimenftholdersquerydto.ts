...
export type AnyTimeNftHoldersQueryDtoType = ClosedEnum<typeof AnyTimeNftHoldersQueryDtoType>;
...
export const AnyTimeNftHoldersQueryDtoParams$inboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    unknown
> = z.union([TimestampRangeNftHoldersParam$inboundSchema, DateRangeNftHoldersParam$inboundSchema]);
...
export type AnyTimeNftHoldersQueryDto$Outbound = {
    id: string;
    type: string;
    params: TimestampRangeNftHoldersParam$Outbound | DateRangeNftHoldersParam$Outbound;
};
