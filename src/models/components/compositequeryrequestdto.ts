...
import { Operator, Operator$inboundSchema, Operator$outboundSchema } from "./operator.js";
...
/** @internal */
export const Queries$inboundSchema: z.ZodType<Queries, z.ZodTypeDef, unknown> = z.union([
    AllTimeNativeBalanceQueryDto$inboundSchema.and(
        z.object({ type: z.literal("AllTimeNativeBalance") }).transform((v) => ({ type: v.type }))
    ),
    AnyTimeNativeBalanceQueryDto$inboundSchema.and(
        z.object({ type: z.literal("AnyTimeNativeBalance") }).transform((v) => ({ type: v.type }))
    ),
    AllTimeErc20BalanceQueryDto$inboundSchema.and(
        z.object({ type: z.literal("AllTimeErc20Balance") }).transform((v) => ({ type: v.type }))
    ),
    AnyTimeErc20BalanceQueryDto$inboundSchema.and(
        z.object({ type: z.literal("AnyTimeErc20Balance") }).transform((v) => ({ type: v.type }))
    ),
    AllTimeNftHoldersQueryDto$inboundSchema.and(
        z.object({ type: z.literal("AllTimeNftHolders") }).transform((v) => ({ type: v.type }))
    ),
    AnyTimeNftHoldersQueryDto$inboundSchema.and(
        z.object({ type: z.literal("AnyTimeNftHolders") }).transform((v) => ({ type: v.type }))
    ),
    LatestBalanceQueryDto$inboundSchema.and(
        z.object({ type: z.literal("LatestBalance") }).transform((v) => ({ type: v.type }))
    ),
    AllTimeStarsArenaBalanceQueryDto$inboundSchema.and(
        z
            .object({ type: z.literal("AllTimeStarsArenaBalance") })
            .transform((v) => ({ type: v.type }))
    ),
    AnyTimeStarsArenaBalanceQueryDto$inboundSchema.and(
        z
            .object({ type: z.literal("AnyTimeStarsArenaBalance") })
            .transform((v) => ({ type: v.type }))
    ),
    LatestStarsArenaBalanceQueryDto$inboundSchema.and(
        z
            .object({ type: z.literal("LatestBalanceStarsArena") })
            .transform((v) => ({ type: v.type }))
    ),
]);
...
export type Queries$Outbound =
    ...
    | (AllTimeStarsArenaBalanceQueryDto$Outbound & { type: "AllTimeStarsArenaBalance" })
    | (AnyTimeStarsArenaBalanceQueryDto$Outbound & { type: "AnyTimeStarsArenaBalance" })
    | (LatestStarsArenaBalanceQueryDto$Outbound & { type: "LatestBalanceStarsArena" });

/** @internal */
export const Queries$outboundSchema: z.ZodType<Queries$Outbound, z.ZodTypeDef, Queries> = z.union([
...
> = z.object({
    ...
    queries: z.array(
        z.union([
            AllTimeNativeBalanceQueryDto$inboundSchema.and(
                z
                    .object({ type: z.literal("AllTimeNativeBalance") })
                    .transform((v) => ({ type: v.type }))
            ),
            AnyTimeNativeBalanceQueryDto$inboundSchema.and(
                z
                    .object({ type: z.literal("AnyTimeNativeBalance") })
                    .transform((v) => ({ type: v.type }))
            ),
            AllTimeErc20BalanceQueryDto$inboundSchema.and(
                z
                    .object({ type: z.literal("AllTimeErc20Balance") })
                    .transform((v) => ({ type: v.type }))
            ),
            AnyTimeErc20BalanceQueryDto$inboundSchema.and(
                z
                    .object({ type: z.literal("AnyTimeErc20Balance") })
                    .transform((v) => ({ type: v.type }))
            ),
            AllTimeNftHoldersQueryDto$inboundSchema.and(
                z
                    .object({ type: z.literal("AllTimeNftHolders") })
                    .transform((v) => ({ type: v.type }))
            ),
            AnyTimeNftHoldersQueryDto$inboundSchema.and(
                z
                    .object({ type: z.literal("AnyTimeNftHolders") })
                    .transform((v) => ({ type: v.type }))
            ),
            LatestBalanceQueryDto$inboundSchema.and(
                z.object({ type: z.literal("LatestBalance") }).transform((v) => ({ type: v.type }))
