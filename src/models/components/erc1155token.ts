...
/** @internal */
export const Erc1155TokenErcType$inboundSchema: z.ZodNativeEnum<typeof Erc1155TokenErcType> =
    z.nativeEnum(Erc1155TokenErcType);

/** @internal */
export const Erc1155TokenErcType$outboundSchema: z.ZodNativeEnum<typeof Erc1155TokenErcType> =
...
/** @internal */
export const Erc1155Token$inboundSchema: z.ZodType<Erc1155Token, z.ZodTypeDef, unknown> = z.object({
    address: z.string(),
