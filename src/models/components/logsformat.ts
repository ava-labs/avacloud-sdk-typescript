...
/** @internal */
export const LogsFormat$inboundSchema: z.ZodType<LogsFormat, z.ZodTypeDef, unknown> = z.object({
    orgId: z.string(),
    logId: z.string(),
...
/** @internal */
export const LogsFormat$outboundSchema: z.ZodType<LogsFormat$Outbound, z.ZodTypeDef, LogsFormat> =
    z.object({
        orgId: z.string(),
        logId: z.string(),
        eventTimestamp: z.number(),
