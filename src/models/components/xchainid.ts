...
/** @internal */
export const XChainId$inboundSchema: z.ZodNativeEnum<typeof XChainId> = z.nativeEnum(XChainId);

/** @internal */
export const XChainId$outboundSchema: z.ZodNativeEnum<typeof XChainId> = XChainId$inboundSchema;
