...
/** @internal */
export const RemovedValidatorDetailsValidationStatus$inboundSchema: z.ZodNativeEnum<
    typeof RemovedValidatorDetailsValidationStatus
> = z.nativeEnum(RemovedValidatorDetailsValidationStatus);

/** @internal */
export const RemovedValidatorDetailsValidationStatus$outboundSchema: z.ZodNativeEnum<
    typeof RemovedValidatorDetailsValidationStatus
...
export namespace RemovedValidatorDetailsValidationStatus$ {
    ...
    export const inboundSchema = RemovedValidatorDetailsValidationStatus$inboundSchema;
    /** @deprecated use `RemovedValidatorDetailsValidationStatus$outboundSchema` instead. */
    export const outboundSchema = RemovedValidatorDetailsValidationStatus$outboundSchema;
}
