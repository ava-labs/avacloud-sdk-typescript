...
/** @internal */
export const ImageAsset$inboundSchema: z.ZodType<ImageAsset, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const ImageAsset$outboundSchema: z.ZodType<ImageAsset$Outbound, z.ZodTypeDef, ImageAsset> =
    z.object({
        assetId: z.string().optional(),
        imageUri: z.string().optional(),
    });
