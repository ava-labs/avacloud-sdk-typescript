...
/** @internal */
export const Delegators$inboundSchema: z.ZodType<Delegators, z.ZodTypeDef, unknown> = z.union([
    ActiveDelegatorDetails$inboundSchema.and(
        z
            .object({ delegationStatus: z.literal("active") })
            .transform((v) => ({ delegationStatus: v.delegationStatus }))
    ),
    PendingDelegatorDetails$inboundSchema.and(
        z
            .object({ delegationStatus: z.literal("pending") })
            .transform((v) => ({ delegationStatus: v.delegationStatus }))
    ),
    CompletedDelegatorDetails$inboundSchema.and(
        z
            .object({ delegationStatus: z.literal("completed") })
            .transform((v) => ({ delegationStatus: v.delegationStatus }))
    ),
]);
...
/** @internal */
export const Delegators$outboundSchema: z.ZodType<Delegators$Outbound, z.ZodTypeDef, Delegators> =
    z.union([
