...
/** @internal */
export const DelegationStatusType$inboundSchema: z.ZodNativeEnum<typeof DelegationStatusType> =
    z.nativeEnum(DelegationStatusType);

/** @internal */
export const DelegationStatusType$outboundSchema: z.ZodNativeEnum<typeof DelegationStatusType> =
