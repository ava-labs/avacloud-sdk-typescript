...
/** @internal */
export const ListCChainAtomicTransactionsResponseTransactions$inboundSchema: z.ZodType<
...
/** @internal */
export const ListCChainAtomicTransactionsResponseTransactions$outboundSchema: z.ZodType<
    ListCChainAtomicTransactionsResponseTransactions$Outbound,
    z.ZodTypeDef,
    ListCChainAtomicTransactionsResponseTransactions
> = z.union([CChainExportTransaction$outboundSchema, CChainImportTransaction$outboundSchema]);
...
export namespace ListCChainAtomicTransactionsResponseTransactions$ {
    ...
    export const inboundSchema = ListCChainAtomicTransactionsResponseTransactions$inboundSchema;
    /** @deprecated use `ListCChainAtomicTransactionsResponseTransactions$outboundSchema` instead. */
    export const outboundSchema = ListCChainAtomicTransactionsResponseTransactions$outboundSchema;
    /** @deprecated use `ListCChainAtomicTransactionsResponseTransactions$Outbound` instead. */
    export type Outbound = ListCChainAtomicTransactionsResponseTransactions$Outbound;
}
...
export type ListCChainAtomicTransactionsResponse$Outbound = {
    nextPageToken?: string | undefined;
    transactions: Array<CChainExportTransaction$Outbound | CChainImportTransaction$Outbound>;
...
export namespace ListCChainAtomicTransactionsResponse$ {
    ...
    export const inboundSchema = ListCChainAtomicTransactionsResponse$inboundSchema;
    /** @deprecated use `ListCChainAtomicTransactionsResponse$outboundSchema` instead. */
    export const outboundSchema = ListCChainAtomicTransactionsResponse$outboundSchema;
