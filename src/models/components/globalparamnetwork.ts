...
/** @internal */
export const GlobalParamNetwork$inboundSchema: z.ZodNativeEnum<typeof GlobalParamNetwork> =
    z.nativeEnum(GlobalParamNetwork);

/** @internal */
export const GlobalParamNetwork$outboundSchema: z.ZodNativeEnum<typeof GlobalParamNetwork> =
