...
/** @internal */
export const TransactionMethodType$inboundSchema: z.ZodNativeEnum<typeof TransactionMethodType> =
    z.nativeEnum(TransactionMethodType);

/** @internal */
export const TransactionMethodType$outboundSchema: z.ZodNativeEnum<typeof TransactionMethodType> =
