...
/** @internal */
export const Method$inboundSchema: z.ZodType<Method, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Method$outboundSchema: z.ZodType<Method$Outbound, z.ZodTypeDef, Method> = z.object({
