...
/** @internal */
export const ValidationStatus$inboundSchema: z.ZodNativeEnum<typeof ValidationStatus> =
    z.nativeEnum(ValidationStatus);

/** @internal */
export const ValidationStatus$outboundSchema: z.ZodNativeEnum<typeof ValidationStatus> =
