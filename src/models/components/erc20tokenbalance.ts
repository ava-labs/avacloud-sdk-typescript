...
export type Erc20TokenBalanceErcType = ClosedEnum<typeof Erc20TokenBalanceErcType>;
...
/** @internal */
export const Erc20TokenBalance$inboundSchema: z.ZodType<Erc20TokenBalance, z.ZodTypeDef, unknown> =
    z.object({
        address: z.string(),
        name: z.string(),
        symbol: z.string(),
