...
/** @internal */
export const Transfers$inboundSchema: z.ZodType<Transfers, z.ZodTypeDef, unknown> = z.union([
    Erc721Transfer$inboundSchema,
    Erc20Transfer$inboundSchema,
    Erc1155Transfer$inboundSchema,
]);
...
/** @internal */
export const Transfers$outboundSchema: z.ZodType<Transfers$Outbound, z.ZodTypeDef, Transfers> =
    z.union([
        Erc721Transfer$outboundSchema,
        Erc20Transfer$outboundSchema,
        Erc1155Transfer$outboundSchema,
...
export type ListTransfersResponse$Outbound = {
    nextPageToken?: string | undefined;
    transfers: Array<Erc721Transfer$Outbound | Erc20Transfer$Outbound | Erc1155Transfer$Outbound>;
};
