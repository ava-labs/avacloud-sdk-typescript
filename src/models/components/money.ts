...
/** @internal */
export const Money$inboundSchema: z.ZodType<Money, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Money$outboundSchema: z.ZodType<Money$Outbound, z.ZodTypeDef, Money> = z.object({
