...
/** @internal */
export const ActiveValidatorDetailsValidationStatus$inboundSchema: z.ZodNativeEnum<
    typeof ActiveValidatorDetailsValidationStatus
> = z.nativeEnum(ActiveValidatorDetailsValidationStatus);

/** @internal */
export const ActiveValidatorDetailsValidationStatus$outboundSchema: z.ZodNativeEnum<
    typeof ActiveValidatorDetailsValidationStatus
...
export namespace ActiveValidatorDetailsValidationStatus$ {
    ...
    export const inboundSchema = ActiveValidatorDetailsValidationStatus$inboundSchema;
    /** @deprecated use `ActiveValidatorDetailsValidationStatus$outboundSchema` instead. */
    export const outboundSchema = ActiveValidatorDetailsValidationStatus$outboundSchema;
}
