 ...
 */
export async function glacierPrimaryNetworkBlocksListLatestPrimaryNetworkBlocks(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ListLatestPrimaryNetworkBlocksRequest$outboundSchema.parse(value$),
    ...
    const baseURL$ =
        options?.serverURL ||
        pathToFunc(ListLatestPrimaryNetworkBlocksServerList[0], { charEncoding: "percent" })();
    ...
    const path$ = pathToFunc("/v1/networks/{network}/blockchains/{blockchainId}/blocks")(
        pathParams$
    );
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ListLatestPrimaryNetworkBlocksResponse$inboundSchema, {
            key: "Result",
        }),
        m$.fail(["4XX", "5XX"])
