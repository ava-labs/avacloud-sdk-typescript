...
import { GetRollingWindowAvgGpsServerList } from "../models/operations/getrollingwindowavggps.js";
 ...
 */
export async function metricsChainThroughputGetRollingWindowAvgGps(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetRollingWindowAvgGpsRequest$outboundSchema.parse(value$),
    ...
    const baseURL$ =
        options?.serverURL ||
        pathToFunc(GetRollingWindowAvgGpsServerList[0], { charEncoding: "percent" })();
    ...
    const path$ = pathToFunc("/v1/avg_gps/{chainId}/rollingWindow")(pathParams$);
