 ...
 */
export async function evmTransactionsListTransfers(
...
> {
    ...
    const path$ = pathToFunc("/v1/chains/{chainId}/tokens/{address}/transfers")(pathParams$);
    ...
    const context = { operationID: "listTransfers", oAuth2Scopes: [], securitySource: null };
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ListTransfersResponse$inboundSchema, { key: "Result" }),
        m$.fail(["4XX", "5XX"])
