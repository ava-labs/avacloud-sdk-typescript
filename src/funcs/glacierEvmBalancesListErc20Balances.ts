 ...
 */
export async function glacierEvmBalancesListErc20Balances(
...
> {
    ...
    const baseURL$ =
        options?.serverURL ||
        pathToFunc(ListErc20BalancesServerList[0], { charEncoding: "percent" })();
    ...
    const path$ = pathToFunc("/v1/chains/{chainId}/addresses/{address}/balances:listErc20")(
        pathParams$
    );
    ...
    const context = { operationID: "listErc20Balances", oAuth2Scopes: [], securitySource: null };
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ListErc20BalancesResponse$inboundSchema, { key: "Result" }),
        m$.fail(["4XX", "5XX"])
