 ...
 */
export async function dataPrimaryNetworkRewardsListHistoricalPrimaryNetworkRewards(
...
> {
    ...
    const baseURL$ =
        options?.serverURL ||
        pathToFunc(ListHistoricalPrimaryNetworkRewardsServerList[0], { charEncoding: "percent" })();
