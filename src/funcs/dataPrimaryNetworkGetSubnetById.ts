 ...
 */
export async function dataPrimaryNetworkGetSubnetById(
...
> {
    ...
    const baseURL$ =
        options?.serverURL || pathToFunc(GetSubnetByIdServerList[0], { charEncoding: "percent" })();
    ...
    const path$ = pathToFunc("/v1/networks/{network}/subnets/{subnetId}")(pathParams$);
