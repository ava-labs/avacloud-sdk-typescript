 ...
 */
export async function primaryNetworkGetAssetDetails(
...
> {
    ...
    const path$ = pathToFunc("/v1/networks/{network}/blockchains/{blockchainId}/assets/{assetId}")(
        pathParams$
    );
    ...
    const context = { operationID: "getAssetDetails", oAuth2Scopes: [], securitySource: null };
