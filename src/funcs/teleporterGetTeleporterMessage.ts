 ...
 */
export async function teleporterGetTeleporterMessage(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetTeleporterMessageRequest$outboundSchema.parse(value$),
    ...
    const context = { operationID: "getTeleporterMessage", oAuth2Scopes: [], securitySource: null };
