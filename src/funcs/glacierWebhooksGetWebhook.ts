 ...
 */
export async function glacierWebhooksGetWebhook(
...
> {
    ...
    const baseURL$ =
        options?.serverURL || pathToFunc(GetWebhookServerList[0], { charEncoding: "percent" })();
    ...
    const context = { operationID: "getWebhook", oAuth2Scopes: [], securitySource: null };
