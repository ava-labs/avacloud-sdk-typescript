...
import { GetRollingWindowMaxTpsServerList } from "../models/operations/getrollingwindowmaxtps.js";
 ...
 */
export async function metricsChainThroughputGetRollingWindowMaxTps(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetRollingWindowMaxTpsRequest$outboundSchema.parse(value$),
    ...
    const baseURL$ =
        options?.serverURL ||
        pathToFunc(GetRollingWindowMaxTpsServerList[0], { charEncoding: "percent" })();
    ...
    const path$ = pathToFunc("/v1/max_tps/{chainId}/rollingWindow")(pathParams$);
