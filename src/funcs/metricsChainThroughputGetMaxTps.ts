...
import { GetMaxTpsServerList } from "../models/operations/getmaxtps.js";
 ...
 */
export async function metricsChainThroughputGetMaxTps(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetMaxTpsRequest$outboundSchema.parse(value$),
    ...
    const baseURL$ =
        options?.serverURL || pathToFunc(GetMaxTpsServerList[0], { charEncoding: "percent" })();

    const pathParams$ = {
        chain: encodeSimple$("chain", payload$.chain, { explode: false, charEncoding: "percent" }),
    };

    const path$ = pathToFunc("/v1/max_tps/{chain}")(pathParams$);
    ...
    const context = { operationID: "getMaxTps", oAuth2Scopes: [], securitySource: null };
