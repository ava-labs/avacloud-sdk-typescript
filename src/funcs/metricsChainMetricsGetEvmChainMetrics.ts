 ...
 */
export async function metricsChainMetricsGetEvmChainMetrics(
...
> {
    ...
    const baseURL$ =
        options?.serverURL ||
        pathToFunc(GetEvmChainMetricsServerList[0], { charEncoding: "percent" })();
    ...
    const context = { operationID: "getEvmChainMetrics", oAuth2Scopes: [], securitySource: null };
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.GetEvmChainMetricsResponse$inboundSchema, { key: "Result" }),
        m$.fail(["4XX", "5XX"])
