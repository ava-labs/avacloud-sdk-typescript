...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetAddressesByBalanceOverTimeRequest$outboundSchema.parse(value$),
    ...
    const baseURL$ =
        options?.serverURL ||
        pathToFunc(GetAddressesByBalanceOverTimeServerList[0], { charEncoding: "percent" })();
    ...
    const path$ = pathToFunc("/v2/chains/{chainId}/contracts/{address}/balances")(pathParams$);
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.GetAddressesByBalanceOverTimeResponse$inboundSchema, {
            key: "Result",
        }),
