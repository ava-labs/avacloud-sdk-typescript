 ...
 */
export async function glacierEvmBalancesListErc1155Balances(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ListErc1155BalancesRequest$outboundSchema.parse(value$),
    ...
    const baseURL$ =
        options?.serverURL ||
        pathToFunc(ListErc1155BalancesServerList[0], { charEncoding: "percent" })();
    ...
    const path$ = pathToFunc("/v1/chains/{chainId}/addresses/{address}/balances:listErc1155")(
        pathParams$
    );
    ...
    const context = { operationID: "listErc1155Balances", oAuth2Scopes: [], securitySource: null };
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ListErc1155BalancesResponse$inboundSchema, { key: "Result" }),
        m$.fail(["4XX", "5XX"])
