...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetNftHoldersByContractAddressRequest$outboundSchema.parse(value$),
    ...
    const baseURL$ =
        options?.serverURL ||
        pathToFunc(GetNftHoldersByContractAddressServerList[0], { charEncoding: "percent" })();
    ...
    const path$ = pathToFunc("/v2/chains/{chainId}/contracts/{address}/nfts:listHolders")(
        pathParams$
    );
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.GetNftHoldersByContractAddressResponse$inboundSchema, {
            key: "Result",
        }),
        m$.fail(["4XX", "5XX"])
