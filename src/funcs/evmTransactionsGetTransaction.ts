 ...
 */
export async function evmTransactionsGetTransaction(
...
> {
    ...
    const path$ = pathToFunc("/v1/chains/{chainId}/transactions/{txHash}")(pathParams$);

    const headers$ = new Headers({
        Accept: "application/json",
    });

    const context = { operationID: "getTransaction", oAuth2Scopes: [], securitySource: null };
