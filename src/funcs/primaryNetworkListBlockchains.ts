 ...
 */
export async function primaryNetworkListBlockchains(
...
> {
    ...
    const context = { operationID: "listBlockchains", oAuth2Scopes: [], securitySource: null };
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ListBlockchainsResponse$inboundSchema, { key: "Result" }),
        m$.fail(["4XX", "5XX"])
