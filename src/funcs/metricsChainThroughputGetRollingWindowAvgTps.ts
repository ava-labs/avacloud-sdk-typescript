...
import { GetRollingWindowAvgTpsServerList } from "../models/operations/getrollingwindowavgtps.js";
 ...
 */
export async function metricsChainThroughputGetRollingWindowAvgTps(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetRollingWindowAvgTpsRequest$outboundSchema.parse(value$),
    ...
    const baseURL$ =
        options?.serverURL ||
        pathToFunc(GetRollingWindowAvgTpsServerList[0], { charEncoding: "percent" })();
    ...
    const path$ = pathToFunc("/v1/avg_tps/{chainId}/rollingWindow")(pathParams$);
